...
var responsive = function responsive2(styles) {
  return function(theme2) {
    var next = {};
    var breakpoints = get(theme2, "breakpoints", defaultBreakpoints);
...
var css = function css2(args) {
  return function(props) {
    ...
    for (var key in styles) {
      ...
      if (key === "variant") {
        var variant = css2(get(theme2, val))(theme2);
      ...
      var scale = get(theme2, scaleName, get(theme2, prop, {}));
...
// src/client.js
var base = css({ fontFamily: "body" })(theme);
console.log(base);
(0, import_css.injectGlobal)(base);
//# sourceMappingURL=client-2CFIGQE4.js.map
